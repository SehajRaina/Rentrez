...
![*Borrelia burgdorferi*](lymedisease.jpg)
[Image source](https://www.sciencesource.com/archive/Lyme-Disease--Borrelia-burgdorferi-Bacteria--SEM-SS2810888.html)

[More Information - Wikipedia](https://en.wikipedia.org/wiki/Borrelia_burgdorferi)

#Scatterplot of %GC
    Create an attractive, publication-worthy scatterplot of %GC using data from the file GC_content.csv. Note: You will have have to calculate %GC Content from this file, which shows %C and %G content for 1000 specimens. Make sure the points for each of the three ‘species’ can be distinguished in the graph as clearly as possible
